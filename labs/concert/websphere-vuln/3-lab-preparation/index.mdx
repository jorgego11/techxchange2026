...
export concert_fqdn=<paste-key-here>
export liberty_fqdn=<paste-key-here>
...
# This regenerates the Concert VM ssh public key if it doesn't exist
...
## 3.4 Verify SSH access to the Liberty servers
...
## 3.5 Confirm the Liberty server is running
...
## 3.6 Confirm Ansible is installed on the Liberty VM
...
## 3.7 Login into IBM Concert for the First Time
...
## 3.8 Obtaining the IBM Concert API Key
...
## 3.9 You're ready to start the Lab
