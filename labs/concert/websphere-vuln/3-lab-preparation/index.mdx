...
## Step 1: Connect to the IBM VPN

Both virtual machines are on IBM Fyre and are only reachable over the IBM VPN.
Connect to the VPN before doing anything else. If you cannot reach the hosts in
the steps below, the VPN is the first thing to check.

## Step 2: Verify access to the Concert UI
